/* ============================================================
   FIRE Dashboard — ui.gauge.js
   View layer: Retirement Readiness gauge + Milestones.
   Pure rendering — reads state + els (declared in app.js), calls
   engine globals (engine.js). No DOM wiring, no persistence here.
   Chart.js lives in ui.chart.js.
   @map: MILESTONES L15 · updateMilestones L23 · updateGauge L36 · buildGauge L50
   ============================================================ */
