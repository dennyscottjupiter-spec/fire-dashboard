/* ============================================================
   ...
   State + persistence + config restore.
   Loaded AFTER ui.chart.js/ui.gauge.js and BEFORE app.js (classic
   scripts share one global scope). These are all definitions: they
   reference app.js globals (els, numFmt, recalc, renderEvents) only
   at call time — the same boot-time forward-reference pattern
   ui.*.js already uses — so load order stays safe.
   Export/import/PDF snapshot live in store.io.js.
   @map: state L14 · DEFAULTS L52 · applyConfig L65 · saveState L207 ·
         loadState L240 · resetSavedData L249
   ============================================================ */
